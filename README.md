...
全 7 章 35 レッスンで構成し、1 レッスン 1 トピックで段階的に学べるようにしています。

## コンテンツ

- **35 レッスン**: 公式シラバス（2023年5月版）の全小カテゴリ（第1〜6章）に加え、UX検定基礎2.0向けの「AI時代のUX能力」（第7章）をカバー（1 レッスン 15 分程度）
- **ドリル 223 問**: 章別出題・ランダム・模擬試験ボリューム（100問）・復習に対応。回答履歴をブラウザに保存
- **図解**: Mermaid 図でプロセスや構造を可視化
...
docs/
  index.md                     トップページ
  lessons/lessonNN/index.md    各レッスン（lesson01〜lesson35）
  quiz/                        ドリル（4 択問題）
    types.ts                   型定義・章メタ情報
...
| 7 | AI時代のUX能力（UX検定基礎2.0） | lesson32〜35 |
