...
UX検定基礎（UXインテリジェンス協会）の合格を目指す学習コンテンツです。全 7 章 35 レッスンと、223 問のドリルで構成しています。
...
全 7 章 35 レッスンで構成しています。1 レッスン 1 トピックで、少しずつ知識を積み上げられます。
...
- [lesson32: ユーザー視点での体験理解力](/lessons/lesson32/)
- [lesson33: AIペルソナと行動観察調査](/lessons/lesson33/)
- [lesson34: 体験構造化力](/lessons/lesson34/)
- [lesson35: 体験品質ディレクション力・高速改善力](/lessons/lesson35/)

## ドリル

各章の内容を 4 択問題で確認できます。回答履歴はブラウザに保存され、間違えた問題だけの復習や、本番と同じ 100 問のランダム出題（模擬試験ボリューム）にも対応しています。
