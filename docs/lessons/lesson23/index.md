...
| 価値マップ（提供すべき価値） | ゲインクリエイター | 顧客に利益をもたらすもの |

作成はまず顧客側から始めます。ジョブを定め、ペインとゲインを洗い出してから、それに応える製品・サービス、ペインリリーバー、ゲインクリエイターの順に検討します。両面がかみ合ったとき、そこにバリュープロポジションが成立します。
...
| 価値マップ | VPC の企業側。製品・サービス、ペインリリーバー、ゲインクリエイターで構成される |
...
- VPC の6要素は**面との対応**で覚える。顧客プロファイル＝ジョブ・ペイン・ゲイン、価値マップ＝製品・サービス・ペインリリーバー・ゲインクリエイター
