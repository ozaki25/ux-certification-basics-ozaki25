...
- 能力面の中核である「UX企画力」の4つの構成要素を整理する

## UXインテリジェンスとは

UXインテリジェンスとは、**UXが重視される時代に、すべてのビジネスパーソンが持つべき精神（マインド）と能力（スキル）**のことです。
...
UXインテリジェンスの能力面である**UX企画力**は、次の4つの要素で整理できます。
...
::: info 「作って終わり」にしない
4つの要素のうちグロースチーム運用が含まれている点は重要です。UXは一度作って完成するものではなく、データをもとに改善し続けて初めて価値を生み続けられます。
:::
...
- UX企画力の4要素（ユーザー理解・ビジネス構築・世界観の体現・グロースチーム運用）は名称と内容の対応を覚える
